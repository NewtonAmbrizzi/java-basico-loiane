...
public class Exercicio07 {
    ...
    public static void main(String[] args) {
        ...
        if (numero1 == numero2 && numero1 == numero3){
            ...
            if (numero1 < numero2 && numero1 < numero3){
                System.out.println("O número 1 é o menor dos 3 números digitados.");
            } else if (numero1 > numero2 && numero2 < numero3){
                System.out.println("O número 2 é o menor dos 3 números digitados.");
            } else {
                System.out.println("O número 3 é o menor dos 3 números digitados.");
            }
        }
